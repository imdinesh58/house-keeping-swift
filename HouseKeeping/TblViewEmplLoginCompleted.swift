//
//  TblViewEmplLoginCompleted.swift
//  HouseKeeping
//
...
class TblViewEmplLoginCompleted: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    @IBOutlet weak var tblViewEmployeeCompletedTasks: UITableView!
    ...
    override func viewDidLoad() {
        ...
        self.tblViewEmployeeCompletedTasks?.delegate = self
        self.tblViewEmployeeCompletedTasks?.dataSource = self
        ...
        if #available(iOS 10.0, *) {
            ...
            refreshControl.addTarget(self,
                                     action: #selector(refreshE2Options(sender:)),
                                     for: .valueChanged)
            self.tblViewEmployeeCompletedTasks.refreshControl = refreshControl
        }
    }
    ...
    @objc private func refreshE2Options(sender: UIRefreshControl) {
        objectsEmpLogin.removeAll()
        objectsEmpLogin2.removeAll()
        objectsEmpLogin3.removeAll()
        objectsEmpLogin4.removeAll()
            ...
            if objectsEmpLogin.isEmpty == true {
                ...
                let task = URLSession.shared.dataTask(with: req as URLRequest) {
                    ...
                    if let httpStatus = response as? HTTPURLResponse, httpStatus.statusCode == 200 {
                        ...
                        print("StatusCode is comp === \(httpStatus.statusCode)")
        ...
        DispatchQueue.main.async(){
            if let data = text.data(using: String.Encoding.utf8) {
                do {
                    ...
                    self.getEmployeeCompletedtasks()
                   // SwiftSpinner.hide()
                } catch {
    ...
    func getEmployeeCompletedtasks() {
        ...
        if AssignedByArr.count == 0 {
            for object in objectsEmpLogin.reversed() {
                ...
                if object.taskStatusID == "1" {
                    ...
                    self.tblViewEmployeeCompletedTasks?.reloadData()
                }
            }
        }
        print("After completed" ,AssignedByArr.count)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.tblViewEmployeeCompletedTasks.dequeueReusableCell(withIdentifier: "ECompletedCell", for: indexPath) as! EmployeeLoginCell
        cell.lbl1?.text = ""
        cell.lbl2?.text = ""
        cell.lbl3?.text = ""
        cell.lbl4?.text = ""
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let send6 = Cell.duration?.text
        
        self.goWorkingPage(pendingText : send! , pendingText2 : send2! , pendingText3 : send3! , pendingText4 : send4!, pendingText5 : send5!, pendingText6 : send6!)
    }
    ...
    func goWorkingPage(pendingText: String, pendingText2: String, pendingText3: String,pendingText4: String,pendingText5: String,pendingText6: String) {
        OperationQueue.main.addOperation {
            let mainStoryboard = UIStoryboard(name: "Main", bundle: Bundle.main)
            let vicCont = mainStoryboard.instantiateViewController(withIdentifier: "viewCompletedtask") as! viewCompletedtask
            ...
            vicCont.DURATION2 = self.sendPendingStr6
