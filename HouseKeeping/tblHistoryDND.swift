    ...
    class tblHistoryDND: UIViewController, UITableViewDelegate, UITableViewDataSource  {
        @IBOutlet weak var tblViewHistoryDND: UITableView!
        @IBOutlet weak var WHSegmentedControl: UISegmentedControl!
        
        override func viewDidLoad() {
            super.viewDidLoad()
            self.tblViewHistoryDND?.delegate = self
            self.tblViewHistoryDND?.dataSource = self
            self.getHistoryAll()
        }
        ...
        func getHistoryAll() {
            ...
            self.tblViewHistoryDND?.reloadData()
        }
        @IBAction func SegControlChange() {
            let cell = self.tblViewHistoryDND.dequeueReusableCell(withIdentifier: "WHcell5") as! workHistoryCell
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            let cell = self.tblViewHistoryDND.dequeueReusableCell(withIdentifier: "WHcell5", for: indexPath) as! workHistoryCell
            cell.HDescription?.text = ""
            cell.HLocation?.text = ""
            cell.HDate?.text = ""
            cell.HStasus?.text = ""
