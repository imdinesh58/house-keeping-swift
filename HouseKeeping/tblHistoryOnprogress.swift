    ...
    class tblHistoryOnprogress: UIViewController, UITableViewDelegate, UITableViewDataSource  {
        @IBOutlet weak var tblViewHistoryOnprogeess: UITableView!
        @IBOutlet weak var WHSegmentedControl: UISegmentedControl!
        
        override func viewDidLoad() {
            super.viewDidLoad()
            self.tblViewHistoryOnprogeess?.delegate = self
            self.tblViewHistoryOnprogeess?.dataSource = self
            self.getHistoryAll()
        }
        ...
        func getHistoryAll() {
            ...
            self.tblViewHistoryOnprogeess?.reloadData()
        }
        @IBAction func SegControlChange() {
            let cell = self.tblViewHistoryOnprogeess.dequeueReusableCell(withIdentifier: "WHcell3") as! workHistoryCell
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            let cell = self.tblViewHistoryOnprogeess.dequeueReusableCell(withIdentifier: "WHcell3", for: indexPath) as! workHistoryCell
            cell.HDescription?.text = ""
            cell.HLocation?.text = ""
            cell.HDate?.text = ""
            cell.HStasus?.text = ""
