...
extension HADropDownDelegate {
    func didSelectItem(dropDown: HADropDown, at index: Int) {
         print("Item 0 selected at index \(index)")
    }
    func didShow(dropDown: HADropDown)  {
...
class HADropDown: UIView {
    ...
    fileprivate var itemFontSize1 : CGFloat = 12.0
    ...
    fileprivate var selectedFont = UIFont.systemFont(ofSize: 12)
    ...
    override func layoutSubviews() {
        ...
        let myColorWhite2 : UIColor = UIColor(red: 255/255.0, green: 128/255.0, blue: 0/255.0, alpha: 1.0)
        self.layer.cornerRadius = 2 //4
        self.layer.borderColor = myColorWhite2.cgColor
    ...
    @objc private func didTap(gesture: UIGestureRecognizer) {
        ...
        if !isCollapsed {
            ...
            self.table.layer.cornerRadius = 2
            var rootView = self.superview
