//
//  TblViewEmplLoginPending.swift
//  HouseKeeping
//
//  Created by Apple-1 on 7/19/17.
...
var objectsEmpLogin : [getAssignedTasks] = []
var objectsEmpLogin2: [getWorkers] = []
var objectsEmpLogin3: [getEmployeeDetailsHousekeeping] = []
var objectsEmpLogin4: [getEmployeeDetailsCarParking] = []
var objectsEmpLogin5: [getEmployeeDetailsMaintenance] = []
var objectsEmpLogin6: [getFloorDetails] = []
var objectsEmpLogin7: [getWorkTypeDetails] = []
var objectsErole1: [getEmployeeDetailsPlumber] = []
var objectsErole2: [getEmployeeDetailsCarpenter] = []
var objectsErole3: [getEmployeeDetailsElectrician] = []
var objectsErole4: [getEmployeeDetailsDriver] = []
var objectsErole5: [getEmployeeDetailsCleaner] = []
var objectsErole6: [getEmployeeDetailsWasher] = []
var objectsErole7: [getEmployeeDetailsArranger] = []

class TblViewEmplLoginPending: UIViewController, UITableViewDelegate, UITableViewDataSource , UIGestureRecognizerDelegate {
    @IBOutlet weak var tblViewEmployeePendingtasks: UITableView!
    //TableView
    ...
    override func viewDidLoad() {
        ...
        self.tblViewEmployeePendingtasks?.delegate = self
        self.tblViewEmployeePendingtasks?.dataSource = self
        
        //DispatchQueue.main.async(){
        //print("objects.isEmpty   " , objectsEmpLogin.isEmpty)
        // if objectsEmpLogin.isEmpty == true || objectsEmpLogin2.isEmpty == true || objectsEmpLogin3.isEmpty == true || objectsEmpLogin4.isEmpty == true || objectsEmpLogin5.isEmpty == true || objectsEmpLogin6.isEmpty == true || objectsEmpLogin7.isEmpty == true {
        print(" if objectsEmpLogin.isEmpty load  ==  " , objectsEmpLogin.isEmpty)
        ...
        if #available(iOS 10.0, *) {
            ...
            refreshControl.addTarget(self,
                                     action: #selector(refreshEOptions(sender:)),
                                     for: .valueChanged)
            self.tblViewEmployeePendingtasks.refreshControl = refreshControl
        }
    }
    ...
    @objc private func refreshEOptions(sender: UIRefreshControl) {
        objectsEmpLogin.removeAll()
        objectsEmpLogin2.removeAll()
        objectsEmpLogin3.removeAll()
        objectsEmpLogin4.removeAll()
    ...
    func getEListJSON(){
        ...
        let task = URLSession.shared.dataTask(with: req as URLRequest) {
            ...
            if let httpStatus = response as? HTTPURLResponse, httpStatus.statusCode == 200 {
                print("StatusCode is all tasks === \(httpStatus.statusCode)")
                let responseString = String(data: data!, encoding: String.Encoding.utf8)
    ...
    func getEmployeePendingtasks() {
        ...
        print("getEmployeePendingtasks()  called")
        if assignedTskArr.count == 0 {
            for object in objectsEmpLogin.reversed() {
                //let defaults = UserDefaults.standard
               // let employeeIDLogins = String(describing: defaults.string(forKey: "employeeIDLogin"))
                if object.taskStatusID == "3" {
                    // if object.taskStatusID == "3" && object.employeeId == employeeIDLogins {
                    ...
                    self.tblViewEmployeePendingtasks?.reloadData()
                }
            }
        }
        print("After Pending" ,assignedTskArr.count)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.tblViewEmployeePendingtasks.dequeueReusableCell(withIdentifier: "EPendingCell", for: indexPath) as! EmployeeLoginCell
        cell.lbl1?.text = ""
        cell.lbl2?.text = ""
        cell.lbl3?.text = ""
        cell.lbl4?.text = ""
