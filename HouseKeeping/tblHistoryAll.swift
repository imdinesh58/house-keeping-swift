...
class tblHistoryAll: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    @IBOutlet weak var tblViewHistoryAll: UITableView!
    @IBOutlet weak var WHSegmentedControl: UISegmentedControl!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tblViewHistoryAll?.delegate = self
        self.tblViewHistoryAll?.dataSource = self
        self.getHistoryAll()
    }
    ...
    func getHistoryAll() {
        ...
        self.tblViewHistoryAll?.reloadData()
    }
    @IBAction func SegControlChange() {
        let cell = self.tblViewHistoryAll.dequeueReusableCell(withIdentifier: "WHcell1") as! workHistoryCell
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.tblViewHistoryAll.dequeueReusableCell(withIdentifier: "WHcell1", for: indexPath) as! workHistoryCell
        //case 0:
        cell.HDescription?.text = ""
        cell.HLocation?.text = ""
        cell.HDate?.text = ""
